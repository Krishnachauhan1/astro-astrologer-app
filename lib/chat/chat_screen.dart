...
//                     Text('Chat with ${'astrologer.name'}', style: const TextStyle(color: AppColors.textSecondary, fontSize: 14)),
...
//           color: msg.isUser ? AppColors.primary : AppColors.surfaceVariant,
...
//           ),
//         ),
//         child: Text(msg.message, style: TextStyle(color: msg.isUser ? Colors.white : AppColors.textPrimary, fontSize: 14)),
//       ),
//     );
//   }
// }